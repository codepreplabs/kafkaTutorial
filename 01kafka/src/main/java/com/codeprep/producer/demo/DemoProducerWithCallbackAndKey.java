...
public class DemoProducerWithCallbackAndKey {

	private static Logger LOG = LoggerFactory.getLogger(DemoProducerWithCallbackAndKey.class);
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			...
			ProducerRecord<String, String> rec = new ProducerRecord<String, String>("first_topic", "id-"+ Integer.toString(i)
